            ...
            <table class="table table-striped">
              ...
              <tbody>
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr id="row_<?php echo ($vo["id"]); ?>">
                  ...
                  <td><?php if($vo["title_pic1"] != ''): ?><a href="/Admin/Index/page?id=<?php echo ($vo["id"]); ?>" target="_blank"><img src="<?php echo ($vo["title_pic1"]); ?>" height="70px;"/></a><?php endif; if($vo["title_pic2"] != ''): ?>&nbsp;<a href="/Admin/Index/page?id=<?php echo ($vo["id"]); ?>" target="_blank"><img src="<?php echo ($vo["title_pic2"]); ?>" height="70px;"/></a><?php endif; if($vo["title_pic3"] != ''): ?>&nbsp;<a href="/Admin/Index/page?id=<?php echo ($vo["id"]); ?>" target="_blank"><img src="<?php echo ($vo["title_pic3"]); ?>" height="70px;"/></a><?php endif; ?><br/><a href="/Admin/Index/page?id=<?php echo ($vo["id"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a>
                  </td>

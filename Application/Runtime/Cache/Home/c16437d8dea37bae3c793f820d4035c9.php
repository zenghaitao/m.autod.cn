...
.nr{overflow: hidden;padding: 6px 60px 6px 0;}
...
.dylist li span{position: absolute;font-size: 10px;padding: 5px 10px;background: #cecfd0;border-radius: 10px;color: #fff;right: 0;top: 30px;}
...
@media screen and (min-width:360px){
    ...
    .nr p{margin-top: 10px;font-size: 16px;}
    ...
    <div class="takebox">
        ...
        <ul class="dylist">
            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><li>
                ...
                <?php if($vo["followed"] == 'yes'): ?><span class="">取消订阅</span>
                <?php else: ?>

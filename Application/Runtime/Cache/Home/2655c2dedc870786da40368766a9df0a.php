...
<body>
    <?php if($hot_comments): ?><div class="com_box">
        <div class="com_title">
            <h2>热门评论</h2>
        </div>
        <ul class="com_ul">
            <?php if(is_array($hot_comments)): foreach($hot_comments as $key=>$vo): ?><li>
                ...
                <div class="com_cont">
                    ...
                    <div class="dianzan">
                        ...
                        <a class="hand" href="autod://com.auto/ding/?newsId=<?php echo ($vo["news_id"]); ?>&replyId=<?php echo ($vo["id"]); ?>"><img src="/Public/images/hand.png" alt=""></a>
